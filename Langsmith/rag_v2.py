...
# Ensure Hugging Face uses the local embedded model cache before importing
# HF-backed classes. This keeps the model files inside the project folder.
...
os.environ["LANGCHAIN_PROJECT"] = "RAG_PROJECT_V2"

PDF_PATH = BASE_DIR / "data" / "islr.pdf"  # change to your file
